                                    ...
                                    <div class="iq-card-body p-0">
                                       <div class="d-flex align-items-center">
                                          <div class="col-6 p-0 position-relative image-overlap-shadow">
                                             <a href=""><img class="img-fluid rounded w-100" src="images/book/{{$p->bookimage}}" alt=""></a>
                                             <div class="view-book">
                                                <a href="pdf/{{$p->bookpdf}}" class="btn btn-sm btn-white">View Book</a>
                                             </div>
                                          </div>
                                          <div class="col-6">
                                             <div class="mb-2">
                                                <h6 class="mb-1">{{$p->bookname}}</h6>
                                                <p class="font-size-13 line-height mb-1">{{$p->bookauthor}}</p>
                                             ...
                                             <div class="price d-flex align-items-center">
                                                <h6><b>Rs.{{$p->bookprice}}</b></h6>
                                             </div>
                                             <div class="iq-product-action">
                                                <a href="/addtocart/{{$p->id}}"><i class="ri-shopping-cart-2-fill text-primary"></i></a>
