                        ...
                        <div class="iq-card-body profile-page">
                           <div class="profile-header">
                              <div class="cover-container text-center">
                                 <img src="images/user/Profile.jpg" alt="profile-bg" class="rounded-circle img-fluid">
                           ...
                           <ul class="list-inline p-0 mb-0">
                              ...
                              <li>
                                 <div class="row align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="col-sm-6">
                                       <p class="mb-0 text-capitalize">{{ Auth::User()->country }}</p>                                       
                                    </div>
                                 </div>
                              </li>
                              <li>
                                 <div class="row align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="col-sm-6">
                                       <p class="mb-0 text-capitalize">{{ Auth::User()->city }}</p>                                       
                                    </div>
                                 </div>
                              </li>                              
